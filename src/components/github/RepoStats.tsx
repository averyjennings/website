      ...
      <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
          ...
          <div className="text-center p-2 sm:p-0">
            ...
            <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Total Stars</div>
          </div>
          ...
          <div className="text-center p-2 sm:p-0">
            ...
            <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Total Forks</div>
          </div>
        ...
        {/* Top Repositories - Mobile Enhanced */}
            ...
            <div className="space-y-2 sm:space-y-3">
              {topRepos.map((repo) => (
                <a
                  ...
                  className="block p-3 sm:p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-blue-300 dark:hover:border-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-200 group touch-manipulation"
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      {/* Repository name and language - Mobile optimized */}
                      <div className="flex flex-col space-y-1 sm:flex-row sm:items-center sm:space-x-2 sm:space-y-0">
                        ...
                        {repo.language && (
                          <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 self-start">
                            {repo.language}
                          </span>
                        )}
                      </div>
                      ...
                      <div className="flex flex-col space-y-1 sm:flex-row sm:items-center sm:space-x-4 sm:space-y-0 mt-2 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <div className="opacity-70 sm:opacity-0 group-hover:opacity-100 transition-opacity ml-2 flex-shrink-0">
